...
//	virtual double V_find(double temp1,double temp2, double temp3);
//	virtual double S_find();
//};
//
...
int main() {
	...
	>>>>>> > —читай только начало, нужно пофиксить ошибки, а так в целом должно быть норм.
		return 0;
}
